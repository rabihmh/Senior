...
@section('my-content')
    ...
    <div class="container">
        ...
        @endif
        <form method="POST" action="{{route('storeServices')}}" enctype="multipart/form-data">
            @csrf
            ...
            <div class=" mt-3 mb-3">
                ...
                <textarea style="resize: none" class="form-control" id="description" rows="5"
            ...
            <div class="form-group mb-3"><label class="form-label" for="file-input">Service photo</label>
                <div class="">
                    <input type="file" name="service_photo" class="dropify" data-height="200" />
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" min="5" class="form-control" id="price" name="service_price">
                    @error('service_price')
                    <small class="form-text text-danger">{{$message}}</small>
                    @enderror
                </div>
